	...
	<div id="left-area">
		...
		<div class="entry clearfix post">	
			...
			<div id="et_pt_gallery" class="clearfix">
				...
				<?php query_posts("showposts=$et_ptemplate_gallery_perpage&paged=$paged" . $gallery_query."&order=ASC"); ?>
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="et_pt_gallery_entry">
						<div class="et_pt_item_image">
							...
							<a class="zoom-icon" title="<?php the_title(); ?>" rel="prettyPhoto[gallery]" href="<?php echo($thumbnail['fullpath']); ?>"><?php _e('Zoom in','Modest'); ?></a>
